...
export interface ApiAdornmentAdornment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Featured collections for the Adornments section on homepage';
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Localized blog articles';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiGlobalConfigurationGlobalConfiguration
  ...
  collectionName: 'global-configurations';
  info: {
...
export interface ApiHeroSliderHeroSlider extends Struct.CollectionTypeSchema {
  collectionName: 'hero-sliders';
  info: {
    displayName: 'Hero-sliders';
...
export interface ApiOtpStoreOtpStore extends Struct.CollectionTypeSchema {
  collectionName: 'otp_stores';
  info: {
    description: 'Store OTPs and reset tokens for password recovery';
    displayName: 'OtpStore';
    pluralName: 'otp-stores';
    singularName: 'otp-store';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    gateway: Schema.Attribute.Text & Schema.Attribute.Required;
    gateway_order_id: Schema.Attribute.Text;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    transaction_id: Schema.Attribute.Text & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ancient_utility: Schema.Attribute.Text;
    cart_items: Schema.Attribute.Relation<'oneToMany', 'api::cart.cart'>;
    categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::category.category'
    >;
    cosmic_story: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    modern_utility: Schema.Attribute.Text;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    order_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-item.order-item'
